...
const TICKET_STATUS_TO_COLUMN_MAP: Record<KanbanTipo, Partial<Record<TicketStatus, string>>> = {
  SUPORTE: {
    ...
    [TicketStatus.EM_PROCESSO_LOGISTICO]: 'Em Atendimento',
  ...
  CHAMADO: {
    ...
    [TicketStatus.EM_PROCESSO_LOGISTICO]: 'Em Andamento',
  ...
  MARKETING: {
    ...
    [TicketStatus.EM_PROCESSO_LOGISTICO]: 'Em Producao',
    [TicketStatus.CONCLUIDO]: 'Concluido',
  },
  EVENTOS: {
    [TicketStatus.ABERTO]: 'Planejamento',
    ...
    [TicketStatus.EM_PROCESSO_LOGISTICO]: 'Em Execucao',
